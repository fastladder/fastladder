...
Event.userDefined = {
    wheeldown(obj, evType, fn, useCapture) {
        const callback = function (e) {
            const count = e.wheelDelta ? e.wheelDelta / -120 : e.detail / 3;
            if (count > 0) {
                fn(e, count);
            }
        };
    ...
    wheelup(obj, evType, fn, useCapture) {
        const callback = function (e) {
            const count = e.wheelDelta ? e.wheelDelta / -120 : e.detail / 3;
            if (count < 0) {
                fn(e, count);
...
Trigger.extend({
    ...
    remove(trigger) {
        this.event_list = this.event_list.reject(pair => pair[0] == trigger);
        return this;
    },
    toggle(state) {
